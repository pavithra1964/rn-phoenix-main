...
const DashboardPanelCertiicateSurvey = (props) => {
    ...
    return (
      <Card style={styles.header}>
        <View style={{ flexDirection: "row" }}>
          ...
          <View style={styles.status}>
            <Text style={styles.title}>days 30</Text>
          </View>
          <View style={styles.status}>
            <Text style={styles.title}>days 60</Text>
          </View>
          <View style={styles.status}>
...
export default DashboardPanelCertiicateSurvey;
